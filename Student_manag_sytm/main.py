    ...
    def ADD_STUDENT_INFORMATION():
        def get_valid_name():
            ...
            while True:
                ...
                NAME =input("PLEASE ENTER YOUR OFFICIAL NAME: ").strip()
                ...
                if all(c.isalpha() or c.isspace() for c in NAME):
                    ...
                    print("THE NAME INCLUDED IS INVALID\n")
                    continue
        valid_name = get_valid_name()
        STUDENT_NAME.append(valid_name)

        def reg_number():
            while True:
                print("PLEASE ENTER YOUR REGISTRATION NUMBER: ",end="")
                regna = input()
                if len(regna) < 8:
                    print("\t\t\tTHE NUMBER OF CHARACTERS SHOULD NOT BE LESS THAN 8!!")

                else:
                    break
        new_regno = reg_number()
        STUDENT_ROLL_NUMBER.append(new_regno)
        ...
        def classyi():
            ...
            while True:
                print("PLEASE ENTER YOUR CLASS: ",end="")
                noty = input()
                if len(noty) < 3 :
        ...
        class_new = classyi()
        STUDENT_CLASS.append(class_new)
        ...
        #def Gmails():
           ...
           # while True:
               # print("PLEASE ENTER YOUR GMAIL: ",end="")
                #mail_v = input()
